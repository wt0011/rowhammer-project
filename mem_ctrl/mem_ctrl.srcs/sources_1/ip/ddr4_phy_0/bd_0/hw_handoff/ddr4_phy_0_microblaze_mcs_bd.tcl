...
################################################################
# This is a generated script based on design: bd_c5bc
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./mem_ctrl/mem_ctrl.srcs/sources_1/ip/ddr4_phy_0/bd_0
