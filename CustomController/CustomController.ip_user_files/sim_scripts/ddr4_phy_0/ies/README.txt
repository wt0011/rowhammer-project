...
#
# Generated by export_simulation on Mon Apr 15 22:51:41 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './ddr4_phy_0.sh' script.

./ddr4_phy_0.sh -reset_run
...
./ddr4_phy_0.sh -noclean_files

For more information on the script, please type './ddr4_phy_0.sh -help'.
